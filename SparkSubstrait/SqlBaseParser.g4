...
@members {
   ...
   */
  public bool legacy_setops_precedence_enabled = false;

  /**
   * When false, a literal with an exponent would be converted into
   * double type rather than decimal type.
   */
  public bool legacy_exponent_literal_as_decimal_enabled = false;

  /**
   * When true, the behavior of keywords follows ANSI SQL standard.
   */
  public bool SQL_standard_keyword_behavior = false;

  /**
   * When true, double quoted literals are identifiers rather than STRINGs.
   */
  public bool double_quoted_identifiers = false;
}
...
primaryExpression
    ...
    | baseRef=primaryExpression DOT fieldName=identifier                                          #dereference
